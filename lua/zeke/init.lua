...
function M.setup(opts)
  ...
  -- Setup logger
  logger.setup(opts.logger or {})

  -- Setup diff module
  diff.setup(opts.diff or {})

  -- Setup selection tracking if enabled
  if opts.track_selection ~= false then
    selection.enable(opts.selection or {})
  end
  ...
  ghostlang.setup(opts.ghostlang or {})
  ...
  logger.info('init', 'Zeke.nvim initialized')
end
